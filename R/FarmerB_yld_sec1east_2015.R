#' @title FarmerB_yld_sec1east_2015
#' @description Winter wheat crop yield (bushels per acre) data
#' collected from Farmer B's Case combine in 2015. Yield
...
#' @format A data frame with 31062 rows and 20 variables:
#' \describe{
