#' @title FarmerB_yld_sec35middle_2018
#' @description Winter wheat crop yield (bushels per acre) data
#' collected from Farmer B's John Deere combine in 2018. Yield
#' data is automatically collected ~3 seconds during harvest.
#' Data is raw yield data with attributes recorded by Farmer
#' B in sec35middle.
#' @format A data frame with 380223 rows and 15 variables:
#' \describe{
